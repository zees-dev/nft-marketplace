...
export default function Home() {
  ...
  async function loadNFTs() {
    ...
    const marketContract = new ethers.Contract(NFT_MARKET_ADDRESS, NFTMarket_ABI.abi, provider)
  ...
  async function buyNft(nft: NFT) {
    ...
    const contract = new ethers.Contract(NFT_MARKET_ADDRESS, NFTMarket_ABI.abi, signer)
